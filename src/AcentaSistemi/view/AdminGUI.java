...
// Admin olarak girildiginde karşılaşılacak ekranın kod kısmı
public class AdminGUI extends JFrame {
    ...
    //Arayüzün boyut özelliklerinin eklendigi kısım
    public AdminGUI(Admin operator) {
     ...
     tbl_user_list.getColumnModel().getColumn(0).setMaxWidth(75);
       ...
       //user ekle butonuna basıldıgında çalışacak kısım
...
//User list butona basıldıgında çalışılacak metotumuz
    ...
    //Userlarımızı load etmek için kullandıgımız kısım
